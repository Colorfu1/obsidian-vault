...
- Robotics: Physical Intelligence PI series, RT-1/RT-2, VLA, AWM/world models, Visual Foresight, PlaNet, Dreamer, pi0.7, FAST, MEM, RDT-1B, GR00T N1, Gemini Robotics 1.5, MolmoAct2, robot foundation models, embodied reasoning agents, flow matching action policies, diffusion action policies.
...
- `Robot/`
  ...
  - `Robot/AWM/` contains action/world model and model-based RL notes, including Visual Foresight, PlaNet, and Dreamer.
