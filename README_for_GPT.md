...
- Robotics: Physical Intelligence PI series, VLA, FAST, MEM, RDT-1B, robot foundation models, flow matching and diffusion action policies.
...
- `Robot/`
  ...
  - Root-level `Robot/*.md` files contain non-PI robotics notes such as ALOHA hardware, ACT, and RDT-1B.
- `RL/`
