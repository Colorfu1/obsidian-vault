...
- Robotics: Physical Intelligence PI series, RT-1/RT-2, VLA, AWM/world models, Visual Foresight, PlaNet, Dreamer, DayDreamer, pi0.7, FAST, MEM, RDT-1B, GR00T N1, Gemini Robotics 1.5, MolmoAct2, robot foundation models, embodied reasoning agents, flow matching action policies, diffusion action policies.
...
- `Robot/`
  ...
  - `Robot/AWM/` contains action/world model and model-based RL notes, including Visual Foresight, PlaNet, Dreamer, and DayDreamer.
...
- [[index/robotics_papers|Robotics Papers Index]]
  - Robotics foundation model, AWM/world model, model-based RL, Physical Intelligence, robot memory, action tokenization, diffusion policies, RT-series VLA notes, humanoid foundation model notes, embodied robot agent notes, deployment-oriented VLA notes, ALOHA hardware, and ACT notes.
