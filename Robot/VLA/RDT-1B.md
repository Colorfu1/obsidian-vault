...
> [!figure] 论文原始模型结构图
> ![[attachments/paper-figures/rdt-1b-model-architecture.png]]
> RDT-1B 的统一动作空间、多模态输入编码、DiT 主干与交替条件注入结构。原图来自 [RDT-1B: a Diffusion Foundation Model for Bimanual Manipulation（arXiv:2410.07864）](https://arxiv.org/abs/2410.07864)，由论文源文件高分辨率导出。
