...
- [RT-2](<Robot/VLA/RT-2 论文综述.md>)
- [FAST](<Robot/VLA/PI/FAST_知识总结.md>)
- [Diffusion Policy](<Robot/VLA/Diffusion Policy 概述.md>)
- [RDT-1B](Robot/VLA/RDT-1B.md)
- [π0.7](Robot/VLA/PI/Pi0_7_technical_report.md)
- [GR00T N1](<Robot/VLA/GR00T N1 综述.md>)
...
| 笔记 | 关键词 |
|---|---|
| [RT-1](<Robot/VLA/RT-1 论文综述.md>) | Robotics Transformer, large-scale robot data |
| [RT-2](<Robot/VLA/RT-2 论文综述.md>) | web-scale VLM, action-as-token |
| [Diffusion Policy](<Robot/VLA/Diffusion Policy 概述.md>) | action diffusion, receding horizon |
| [RDT-1B](Robot/VLA/RDT-1B.md) | DiT, continuous action chunk, diffusion policy |
...
| 笔记 | 关键词 |
|---|---|
| [pi0](<Robot/VLA/PI/Pi_0机器人文章分析.md>) | flow matching, action expert, OpenPI |
| [pi0.5](<Robot/VLA/PI/Pi_0.5综述.md>) | long-horizon, language intermediate outputs |
| [pi0.6](<Robot/VLA/PI/Pi_0.6论文问题解答.md>) | FAST tokens, Knowledge Insulation |
| [pi*0.6 / RECAP](<Robot/VLA/PI/Pi_star0.6论文问题解答.md>) | value model, advantage-conditioned policy |
...
| [MEM](<Robot/VLA/PI/MEM 文章分析.md>) | robot memory, long-horizon control |
